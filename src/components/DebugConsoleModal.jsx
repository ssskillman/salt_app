...
const MAPPING_SECTIONS = [
  ...
  {
    title: "App.jsx · Create & Close (YoY card)",
    dataset: "createCloseYoyCard",
    sourceKey: "source_create_close_yoy_card",
    fields: [
      ["Opp id", "opp_id"],
      ["Opp name", "opp_name"],
      ["Business line", "business_line"],
      ["Opp owner", "opp_owner_name"],
      ["Account", "account_name"],
      ["Stage", "stage_name"],
      ["Close date", "close_date"],
      ["Close FYQ", "close_fiscal_yearquarter"],
      ["Is C&C", "is_create_and_close"],
      ["Is closed won", "is_closed_won"],
      ["Is CC open pipe", "is_create_and_close_open_pipe"],
      ["Closed ACV", "closed_acv"],
      ["Open pipe ACV", "open_pipeline_acv"],
      ["CY won $ (QTD window)", "ccy_curr_won_acv"],
      ["PY won $ (same QTD)", "ccy_prior_won_acv"],
      ["PTY QTD C&C won $ (prior quarter, opp-level)", "pty_qtd_closed_won_acv"],
      ["CY open $ (QTD window)", "ccy_curr_open_acv"],
      ["PY open $ (same QTD)", "ccy_prior_open_acv"],
      ["Fiscal year quarter (ctx)", "fiscal_year_quarter"],
      ["Prior FYQ (ctx)", "prior_year_fiscal_year_quarter"],
      ["As of date", "as_of_date"],
      ["Day of quarter", "day_of_quarter"],
      ["Curr QTD start", "curr_qtd_start"],
      ["Curr QTD cap", "curr_qtd_cap_date"],
      ["PY QTD start", "py_qtd_start"],
      ["PY QTD cap", "py_qtd_cap_date"],
      ["Row JSON", "ccy_yoy_row_json"],
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [["Row payload (JSON)", "hmd_row_payload"]],
  },
  {
...
// -----------------------------
    ...
    const datasets = {
      ...
      createCloseYoyCard: { rows: rows?.createCloseYoyCard ?? [], cols: columns?.createCloseYoyCard },
