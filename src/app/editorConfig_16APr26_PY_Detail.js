...
export const editorConfig = [
  ...
  // ------------------------------------------------------------
  { name: "source_drill_forecast_attainment", type: "element", label: "CORE · Drill: Forecast Attainment Detail" },
  { name: "fa_fiscal_year", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: Fiscal Year" },
  { name: "fa_fiscal_yearquarter", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: Fiscal Yearquarter" },
  { name: "fa_business_line", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: Business Line" },
  { name: "fa_qtd_forecast", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: QTD Forecast" },
  { name: "fa_qtd_closed", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: QTD Closed Won ACV" },
  { name: "fa_qtd_closed_vs_forecast", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: QTD Closed vs Forecast" },
  { name: "fa_qtd_attainment", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: QTD Forecast Attainment %" },
  { name: "fa_ytd_forecast", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: YTD Forecast" },
  { name: "fa_ytd_closed", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: YTD Closed Won ACV" },
  { name: "fa_ytd_attainment", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: YTD Forecast Attainment %" },
  { name: "fa_prompted_row", type: "column", source: "source_drill_forecast_attainment", label: "CORE · FA: Prompted Row Flag (TRUE/FALSE)" },
  ...
  { name: "eso_closed_acv", type: "column", source: "source_employee_scope_opportunity_spine", label: "CORE · ESO: Closed ACV" },
  ...
  // ✅ NEW: PY Drill Source
  { name: "source_large_deals_py_detail", type: "element", label: "CORE · Large Deals PY Detail" },


  { name: "ldpy_opp_owner_name", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Opp Owner Name" },
  { name: "ldpy_account_name", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Account Name" },
  { name: "ldpy_opp_id", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Opp ID" },
  { name: "ldpy_opp_name", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Opp Name" },
  { name: "ldpy_stage_name", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Stage Name" },
  { name: "ldpy_close_date", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Close Date" },
  { name: "ldpy_business_line", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Business Line" },
  { name: "ldpy_fiscal_yearquarter", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Fiscal YearQuarter" },
  { name: "ldpy_closed_acv", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Closed ACV" },
  { name: "ldpy_large_deal_bucket", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Large Deal Bucket" },
  { name: "ldpy_deal_review_short", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Deal Review Short" },
  { name: "ldpy_deal_review_details", type: "column", source: "source_large_deals_py_detail", label: "LDPY · Deal Review Details" },
];
